...
public class MapFragment extends Fragment implements OnMapReadyCallback, MapActionsDelegate {
    ...
    public Polyline addPolyline(PolylineOptions pO){
    ...
    public void getMapAsync (OnMapReadyCallback callback){
        com.google.android.gms.maps.MapFragment.newInstance().getMapAsync(callback);
    }
...
interface MapActionsDelegate {
    ...
    Polyline addPolyline(PolylineOptions pO);
